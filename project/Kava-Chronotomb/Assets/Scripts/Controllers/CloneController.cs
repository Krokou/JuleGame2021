...
public class CloneController : MonoBehaviour
{
    ...
    // Needs an own instance of PlayerMovementHandler to control.
    ...
    private PlayerMovementHandler playerMovement = new PlayerMovementHandler();
    private bool controllerBoolean = false;

    private MovementData movementData = new MovementData();
    public InputRecorderHandler recorder = new InputRecorderHandler();
